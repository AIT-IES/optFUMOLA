function result = nsga2(optFUMOLAobj, opt, varargin)
...
[pop, state] = evaluate(opt, pop, state, optFUMOLAobj, varargin{:});  %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
while( ngen < opt.maxGen && STOP_NSGA==0)
    ...
    [newpop, state] = evaluate(opt, newpop, state, optFUMOLAobj, varargin{:});    %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
